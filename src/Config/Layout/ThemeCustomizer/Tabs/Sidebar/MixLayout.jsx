...
import { MixLayout } from "../../../../../Config/Constant";
import CustomizerContext from "../../../../../_helper/Customizer";
import CommenUL from "../Sidebar/CommenUL";

const MixLayoutComponent = () => {
  const { addMixBackgroundLayout, setMixLayout } =
    useContext(CustomizerContext);
  const mixLayout =
    localStorage.getItem("mix_background_layout") ||
    ConfigDB.data.color.mix_background_layout;
